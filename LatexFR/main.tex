...
\newline
- Android développment avec l'achitecture Android + SQLite3 + RESTful APIs(Symfony2) + MongoDB/ElasticSearch. ActionBarSherlock, ViewPagerIndicator et autre open-source libraries sont integrated in this application. This application has the same function as Dropbox.
